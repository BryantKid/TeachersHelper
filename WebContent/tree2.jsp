...
var treeMenu = [
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"users/Users_query.action"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:2, name:"课程列表", ico:"images/icon_default.gif",link:"course/Course_query.action"},
	{ level:2, name:"班级列表", ico:"images/icon_default.gif",link:"classroom/Classroom_query.action"},
	{ level:1, name:"评教管理"},
	{ level:2, name:"教学成果", ico:"images/icon_default.gif",link:"course/course_SumAll.jsp"},
	{ level:2, name:"教研成果", ico:"images/icon_default.gif",link:"projects/projects_SumAll.jsp"},
	{ level:2, name:"评分管理", ico:"images/icon_default.gif",link:"users/Users_grade_query.jsp"},
	{ level:2, name:"优秀教师管理", ico:"images/icon_default.gif",link:"users/Users_excellent.jsp"},
	{ level:1, name:"账号中心"},
	{ level:2, name:"修改密码", ico:"images/icon_default.gif",link:"admins/Admins_modifybtn.jsp"},
];
</script>
<style>
* {
